...
MaxSpeed:      DW 400  ; Must be divisible by 4
MidSpeed:      DW 240  ;
SlowSpeed:     DW 100  ;
MaxSpeed_temp: DW 0    ;
Margin_Mid_X:  DW 870
...
TurnAngle:     DW 80   ; Angle to target that activates turn only mode
TurnAngleMax:  DW 80   ; Angle to target that activates turn only when not near edge
TurnAngleEdge: DW 50   ; Angle to target that activates turn only when near edge
TurnAngle_temp: DW 0
