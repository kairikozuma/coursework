...
coverage analyze -r -plan / -test simple1
coverage analyze -r -plan / -test simple2
coverage analyze -r -plan / -test simple1 simple2
...
coverage analyze -plan / -r -select weight -eq 1 -test simple1 simple2
