...
IconMatch:	addi	$1, $0, CandBase	# point to base of Candidates
		...
		addi	$5, $0, 0				# Initialize index of pattern element (element 0)
...
StIn:	lw 		$3, PatternBase($5)		# Load element from candidate base
		bne		$3, $0, Loop			# If element is not zero, start comparison loop
		addi	$5, $5, 4				# Increment offset of candidate element
		j		StIn	 				# Jump to beginning of loop
