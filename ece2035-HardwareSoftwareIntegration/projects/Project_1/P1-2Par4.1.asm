...
IconMatch: addi	$1, $0, CandBase     	# point to base of Candidates
		...
		addi	$5, $0, 144				# Initialize index of pattern element (element -1)
...
Skip:	addi	$6, $6, 1				# Increment candidate number
...
Exit:	addi 	$6, $0, -1				# Initialize index
...
SetCan: add		$2, $6, $0				# Set index offset as pattern answer        
